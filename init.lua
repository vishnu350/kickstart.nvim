...
require('lazy').setup({
  checker = { enabled = false }, -- Disable automatic check for outdated packages
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = {
          { name = 'nvim_lsp', keyword_length = 15 }, -- Essentially disable autocompletion menu popups
          { name = 'luasnip' },
          { name = 'path' },
        },
      }
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown_inline', 'vim', 'vimdoc' },
